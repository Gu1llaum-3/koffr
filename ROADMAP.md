...
| 2   | Sauvegarder une base vers un fichier chiffré | 20      | en recette | `docs/plans/lot-2-sauvegarde.md` | |
| 2c  | Corrections de recette du lot 2            | 7 `A-nn` | plan en cours | `docs/plans/lot-2-corrections.md` | |
